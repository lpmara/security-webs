...
export const Index = () => {
    ...
    const [textData, setTextData] = useState({
      ...
      const [imageCollumn, setImageCollumn] = useState(4);
          ...
          <div className={styles.flexContainerTop}>
            ...
            <div className={styles.courseContainer}>
                ...
                <div className={styles.imageCourse}>
                    <Gallery photos={photos} margin={5} columns={imageCollumn} direction={"column"} />
                </div>
            </div>
            <div className={styles.courseContainer}>
                ...
                <div className={styles.imageCourse}>
                    <Gallery photos={photos2} margin={5} columns={imageCollumn} direction={"column"} />
                </div>
            </div>
            <div className={styles.courseContainer}>
                ...
                <div className={styles.imageCourse}>
                    <Gallery photos={photos3} margin={5} columns={imageCollumn} direction={"column"} />
                </div>
            </div>
            <div className={styles.courseContainer}>
                ...
                <div className={styles.imageCourse}>
                    <Gallery photos={photos4} margin={5} columns={imageCollumn} direction={"column"} />
                </div>
            </div>
          </div>
        </div>
